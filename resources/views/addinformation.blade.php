      ...
      <div class="border shadow bg-white rounded-3">
        <form action="" method="POST" class="p-4 pb-2">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="_name" class="form-control" placeholder="John Doe" autocomplete="off" value="{{ Auth::user()->name != "null" ? Auth::user()->name : "" }}" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <div class="row">
              ...
              <div class="col ps-1">
                <input type="tel" name="_tel" class="form-control" placeholder="123456789" style="max-width: 140px;" value="{{ Auth::user()->phone_number != "null" ? implode(" " , array_slice(explode(" ", Auth::user()->phone_number), 1)) : "" }}"> 
              </div>
            </div>
          </div>
