...
<div class="d-flex flex-column align-items-center justify-content-center py-4">
  ...
  <div class="bg-light rounded-3">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-auto">
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control" accept="image/png, image/jpeg, image/heic" name="mainimg" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label  class="form-label"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
    ...
    @foreach ($errors->all() as $error)
      <p class="text-danger px-2 text-center"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle-fill" viewBox="0 0 16 16">
